        ...
        try:
            ...
            for line in lines:
                ...
                if line.startswith("#EXTINF"):
                    ...
                    # Αφαιρούμε το παλιό [1080p] από το υπάρχον αρχείο για να γίνει σωστή σύγκριση
        ...
        for url in links:
            ...
            try:
                ...
                if v:
                    ...
                    # Αλλαγή Εδώ: Περνάμε ΜΟΝΟ το `title` (χωρίς το `[{label}]`) στο λεξικό
...
if __name__ == "__main__":
    main()from seleniumbase import SB
from bs4 import BeautifulSoup
import re
import time
import os
